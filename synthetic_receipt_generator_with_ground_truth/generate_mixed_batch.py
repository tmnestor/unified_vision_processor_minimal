...
def generate_mixed_batch_with_bank_statements(
    output_dir: str = typer.Option("test_synthetic", help="Output directory for generated documents"),
    ...
    console.print(f"🏭 Generating {count} mixed documents including {bank_statements} bank statements", style="bold blue")
    ...
    for i in range(count):
        ...
        invoice_data = generator.create_invoice_data(selected_type, num_items, include_bank_data)
        ...
        console.print(f"  {i+1:2d}. {filename} ({doc_type}, {num_items} items{bank_indicator})")
    ...
    console.print(f"✅ Generated {count} documents in {output_path}", style="bold green")
    console.print(f"📋 Includes {bank_statements} bank statements with banking field data", style="green")
