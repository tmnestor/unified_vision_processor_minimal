...
def convert_to_csv(
    ...
    try:
        ...
        console.print(f"📂 Loading batch results from: {batch_file}")
        batch_dataframe = batch_results_to_dataframe(
            batch_results_path=batch_file, config_path=config, use_na_strings=keep_na
        )
...
def analyze_batch_results(
    ...
    try:
        console.print(f"📊 Analyzing batch results from: {batch_file}")
